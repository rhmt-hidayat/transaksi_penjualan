...
//C:\xampp\htdocs\sid-desa\desa\upload\user_pict pindah ke
define("LOKASI_USER_PICT", 'e-ktp/images/');
//define("LOKASI_USER_PICT", 'images/');
//C:\xampp\htdocs\sid-desa\e-ktp\images
 ...
 */
  ...
  */
  ...
  function get_dynamic_title_page_from_path()
  {
    ...
    $ci = get_instance();
    $cmb = "<select name='$name' class='form-control selectpicker' $extra>";
